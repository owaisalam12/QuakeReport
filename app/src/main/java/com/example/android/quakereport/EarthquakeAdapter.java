...
public class EarthquakeAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Earthquake my_data = (Earthquake) getItem(position);
...
// Format the magnitude to show 1 decimal place
        String formattedMagnitude = formatMagnitude(my_data.getMagnitude());
        ...
        String location=my_data.getPlace();
       // place.setText(my_data.getPlace());
        if(location.contains("of")){
            String[] locations=location.split("of");
            locationOffset.setText(locations[0]+" of");
            primaryLocation.setText(locations[1]);
        }
        else{
            locationOffset.setText("Near of");
            primaryLocation.setText(location);
        }


        // Create a new Date object from the time in milliseconds of the earthquake
        Date dateObject = new Date(my_data.getTime());
        ...
        int magnitudeColor = getMagnitudeColor(my_data.getMagnitude());
